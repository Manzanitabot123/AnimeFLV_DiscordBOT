...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('acción').setDescription('Seleccióna una acción o reacción').setRequired(true).addChoices(
        {
            name: 'Alegrarse | happy', 
            value: 'happy'
        },
        {
            name: 'Dormirse | sleep', 
        ...
        {
            name: 'Pulgar arriba | thumbsup', 
            value: 'thumbsup'
        },
        {
            name: 'Mirar fijamente | stare', 
            value: 'stare'
        },
        {
            name: 'Sonreír | smile', 
        ...
        {
            name: 'Decir idiota | baka', 
            value: 'baka'
        },
        {
            name: 'Sonrojarse | blush', 
            value: 'blush'
        },
        {
            name: 'Pensar | think', 
        ...
        {
            name: 'Encoger hombros | shrug', 
            value: 'shrug'
        },
        {
            name: 'Aburrirse | bored', 
            value: 'bored'
        },
        {
            name: 'Patear | kick', 
