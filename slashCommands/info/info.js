...
module.exports.run = (client, interaction, options) => {
    ...
    async function searchslash(){
                                                ...
                                                const collector5 = message.createMessageComponentCollector({
                                                    ...
                                                    collector5.on('collect', async b => {
                                                        ...
                                                        if (b.customId === "one5") { 
                                                            ...
                                                            return await respuesta5_1(browser, page, urlone, eltitulo, eltipo);
            ...
            async function respuesta5_1(browser, page, urlone, eltitulo, eltipo)
            {   
                try{
                //detalles
...
module.exports.conf = {
    ...
    "options":[
        {
            "name": "anime",
            "description": "El nombre del anime que quieres buscar",
            "type": 3,
            "required": true
        }
    ],
